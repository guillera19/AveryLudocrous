package edu_up_cs301.game.util;
            ...
            Runnable newRunner1 = new Runnable() {
                public void run() {
                    if (flashDraw != null) {
                        ...
                        edu_up_cs301.game.util.FlashSurfaceView.this.setBackground(flashDraw);
                        edu_up_cs301.game.util.FlashSurfaceView.this.invalidate();
                    }
                }
            };
            Runnable newRunner2 = new Runnable() {
                public void run() {
                    if (restoreDraw != null) {
                        ...
                        edu_up_cs301.game.util.FlashSurfaceView.this.setBackground(restoreDraw);
                        edu_up_cs301.game.util.FlashSurfaceView.this.invalidate();
